...
func DatabaseUserMap(dbUser database.User) User {
	return User{
		ID:        dbUser.ID,
...
func DatabaseFeederMap(dbFeed database.Feed) Feed {
	return Feed{
		ID:        dbFeed.ID,
...
func DatabaseFeedFollowMap(dbFeedFollow database.FeedFollow) FeedFollow {
	return FeedFollow{
		ID:        dbFeedFollow.ID,
...
func DatabasePostMap(dbPost database.Post) Post {
...
func DatabasePostsMap(dbPost []database.Post) []Post {
	var posts []Post
	for _, post := range dbPost {
		posts = append(posts, DatabasePostMap(post))
	}
	return posts
}
